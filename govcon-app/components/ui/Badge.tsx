...
export function sourceLabel(source: OpportunitySource): string {
  const map: Record<string, string> = {
    ...
    local_ura:                'Local · URA',
    local_housing_authority:  'Local · HACP',
    local_prt:                'Local · PRT',
    local_pwsa:               'Local · Pittsburgh Water',
    local_ppa:                'Local · Parking Auth.',
    local_sea:                'Local · SEA',
    local_alcosan:            'Local · ALCOSAN',
    local_airport_authority:  'Local · Airport Auth.',
